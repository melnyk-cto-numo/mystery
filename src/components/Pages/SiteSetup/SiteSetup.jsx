...
const headerTableName = {
    bss: {
        ...
        control: ['No', 'Link', 'Name', 'Off Names', 'BSS Types', 'ON', 'Read Only', 'Type', 'Object ID', 'SV ID'],
    },
    hal: {
    ...
    tesira: {
        ...
        control: ['No', 'Link', 'Name', 'ON', 'Read Only', 'Type', 'Instance ID', 'Index'],
    },
    xilica: {
        faders: ['No', 'Link', 'ON', 'Name', 'Object Name'],
        altFader1: ['No', 'Link', 'ON', 'Object Name'],
        altFader2: ['No', 'Link', 'ON', 'Object Name'],
        altFader3: ['No', 'Link', 'ON', 'Object Name'],
        altToggle: ['No', 'Link', 'ON', 'Invert', 'Object Name'],
        mute: ['No', 'Link', 'ON', 'Invert', 'Object Name'],
        meter1: ['No', 'Link', 'ON', 'Object Name'],
        meter2: ['No', 'Link', 'ON', 'Object Name'],
        hg: ['No', 'Link', 'ON', 'Object Name'],
        control: ['No', 'Link', 'Name', 'ON', 'Read Only', 'Type', 'Object Name'],
    },
};
