...
const headerTableName = {
    ...
    xilica: {
        faders: ['No', 'Bank', 'Link', 'ON', 'Name', 'Object Name'],
        altFader1: ['No', 'Bank', 'Link', 'ON', 'Object Name'],
        altFader2: ['No', 'Bank', 'Link', 'ON', 'Object Name'],
        altFader3: ['No', 'Bank', 'Link', 'ON', 'Object Name'],
        altToggle: ['No', 'Bank', 'Link', 'ON', 'Invert', 'Object Name'],
        mute: ['No', 'Bank', 'Link', 'ON', 'Invert', 'Object Name'],
        meter1: ['No', 'Bank', 'Link', 'ON', 'Object Name'],
        meter2: ['No', 'Bank', 'Link', 'ON', 'Object Name'],
        hg: ['No', 'Bank', 'Link', 'ON', 'Object Name'],
